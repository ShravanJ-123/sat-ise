...
type AppState = 'landing' | 'quiz' | 'browse' | 'summary';
...
export default function App() {
  ...
  const startQuiz = (count: number = 100) => {
    ...
    <div id="app-container" className="min-h-screen bg-slate-50 font-sans text-slate-900">
            ...
            >
              ...
              <section id="hero" className="text-center space-y-6">
                <h2 className="mx-auto max-w-3xl text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
                  Master Satellite Communications & Navigation
                </h2>
                <p className="mx-auto max-w-2xl text-lg text-slate-600">
                  Comprehensive prep tool with 100 MCQs based on your course modules. Practice Multiple Access, Earth Station Technology, and GPS.
                </p>
              ...
              <section id="modules" className="space-y-4">
                <h3 className="text-2xl font-bold text-slate-800">Learning Path</h3>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-slate-500">Review all 100 questions and their correct answers.</p>
                </div>
                <button 
                  onClick={() => setViewState('landing')}
      ...
      <footer className="mt-20 border-t border-slate-200 bg-white py-12 px-6">
        <div className="mx-auto max-w-7xl text-center text-slate-400">
          <p className="text-sm">Created for Satellite Communication Exam Prep</p>
